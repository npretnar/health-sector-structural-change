...
sink(paste0(results_dir,"/2_counterfactual_analyses_SCRIPT_GE_Calibration_HS_Markups_Full_Calibration.txt")) # prints in-line data into a txt file
...
png(filename=paste(results_dir,"/figureD4a.png",sep=""),width=5,height=4,units="in",res=600)
par(mar = c(2,5,2,2))
...
png(filename=paste(results_dir,"/figureD11a.png",sep=""),width=5,height=4,units="in",res=600)
par(mar = c(2,5,2,2))
...
png(filename=paste(results_dir,"/figureD12a.png",sep=""),width=5,height=4,units="in",res=600)
par(mar = c(2,5,2,2))
...
png(filename=paste(results_dir,"/figureD4b.png",sep=""),width=5,height=4,units="in",res=600)
par(mar = c(2,5,2,2))
...
#le_counters_normalized$year = seq(1950,2050,5)
cols = c("blue","red","purple") #,"darkgreen","darkorange","gold2") #"goldenrod4","darkseagreen","cornflowerblue","darkcyan","darksalmon","gold2")
png(filename=paste(results_dir,"/figureD11b.png",sep=""),width=5,height=4,units="in",res=600)
par(mar = c(2,5,2,2))
...
#le_counters_normalized$year = seq(1950,2050,5)
cols = c("darkorange","darkcyan","goldenrod4") #"goldenrod4","darkseagreen","cornflowerblue","darkcyan","darksalmon","gold2")
png(filename=paste(results_dir,"/figureD12b.png",sep=""),width=5,height=4,units="in",res=600)
par(mar = c(2,5,2,2))
...
png(filename=paste(results_dir,"/figureD4c.png",sep=""),width=5,height=4,units="in",res=600)
par(mar = c(2,5,2,2))
...
#he_counters_normalized$year = seq(1950,2050,5)
cols = c("blue","red","purple") #,"darkgreen","darkorange","gold2") #"goldenrod4","darkseagreen","cornflowerblue","darkcyan","darksalmon","gold2")
png(filename=paste(results_dir,"/figureD11c.png",sep=""),width=5,height=4,units="in",res=600)
par(mar = c(2,5,2,2))
...
#he_counters_normalized$year = seq(1950,2050,5)
cols = c("darkorange","darkcyan","goldenrod4") #"goldenrod4","darkseagreen","cornflowerblue","darkcyan","darksalmon","gold2")
png(filename=paste(results_dir,"/figureD12c.png",sep=""),width=5,height=4,units="in",res=600)
par(mar = c(2,5,2,2))
...
png(filename=paste(results_dir,"/figureD4d.png",sep=""),width=5,height=4,units="in",res=600)
par(mar = c(2,5,2,2))
...
#k_share_normalized$year = seq(1950,2050,5)
cols = c("blue","red","purple") #,"darkgreen","darkorange","gold2") #"goldenrod4","darkseagreen","cornflowerblue","darkcyan","darksalmon","gold2")
png(filename=paste(results_dir,"/figureD11d.png",sep=""),width=5,height=4,units="in",res=600)
par(mar = c(2,5,2,2))
...
#k_share_normalized$year = seq(1950,2050,5)
cols = c("darkorange","darkcyan","goldenrod4") #"goldenrod4","darkseagreen","cornflowerblue","darkcyan","darksalmon","gold2")
png(filename=paste(results_dir,"/figureD12d.png",sep=""),width=5,height=4,units="in",res=600)
par(mar = c(2,5,2,2))
...
png(filename=paste(results_dir,"/figureD4e.png",sep=""),width=5,height=4,units="in",res=600)
par(mar = c(2,5,2,2))
...
#l_share_normalized$year = seq(1950,2050,5)
cols = c("blue","red","purple") #,"darkgreen","darkorange","gold2") #"goldenrod4","darkseagreen","cornflowerblue","darkcyan","darksalmon","gold2")
png(filename=paste(results_dir,"/figureD11e.png",sep=""),width=5,height=4,units="in",res=600)
par(mar = c(2,5,2,2))
...
#l_share_normalized$year = seq(1950,2050,5)
cols = c("darkorange","darkcyan","goldenrod4") #"goldenrod4","darkseagreen","cornflowerblue","darkcyan","darksalmon","gold2")
png(filename=paste(results_dir,"/figureD12e.png",sep=""),width=5,height=4,units="in",res=600)
par(mar = c(2,5,2,2))
...
png(filename=paste(results_dir,"/figureD4f.png",sep=""),width=5,height=4,units="in",res=600)
par(mar = c(2,5,2,2))
...
cols = c("blue","red","purple") #,"darkgreen","darkorange","gold2") #"goldenrod4","darkseagreen","cornflowerblue","darkcyan","darksalmon","gold2")
png(filename=paste(results_dir,"/figureD11f.png",sep=""),width=5,height=4,units="in",res=600)
par(mar = c(2,5,2,2))
...
#gy_counters_normalized$year = seq(1950,2050,5)
cols = c("darkorange","darkcyan","goldenrod4") #"goldenrod4","darkseagreen","cornflowerblue","darkcyan","darksalmon","gold2")
png(filename=paste(results_dir,"/figureD12f.png",sep=""),width=5,height=4,units="in",res=600)
par(mar = c(2,5,2,2))
