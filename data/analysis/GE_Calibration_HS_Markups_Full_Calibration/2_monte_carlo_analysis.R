...
sink(paste0(results_dir,"/2_monte_carlo_results_GE_Calibration_HS_Markups_Full_Calibration.txt"))

print("Monte Carlo Results for GE_Calibration_HS_Markups_Full_Calibration")
