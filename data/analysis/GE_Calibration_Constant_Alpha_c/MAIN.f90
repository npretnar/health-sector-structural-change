...
if(demand_calibration)then
	...
	g_Z = 0.0031d0 !0.00237319117015754d0
	Z_0 = 16.4665276309072d0
...
if(optimal_parms)then
    ...
    ! write predictions for share/price analysis
    do im = 1,5
    
		out_string(1:12) = "pred_moments"
		out_string(13:13) = trim(str(im))
		out_string(14:17) = ".txt"
		inquire(file = out_string(1:17), exist=exists)
		if(exists) then
		...
		write(120001+im,*) price_share_predictions(:,im)
		close(120001+im)
