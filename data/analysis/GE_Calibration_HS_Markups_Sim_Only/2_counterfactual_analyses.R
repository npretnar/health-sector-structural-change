...
sink(paste0(results_dir,"/2_counterfactual_analyses_SCRIPT_GE_Calibration_HS_Markups_Sim_Only.txt")) # prints in-line data into a txt file

print("#########################################################################")
print("#########################################################################")
print("#########################################################################")
print("Now running Calibration R script for GE_Calibration_HS_Markups_Sim_Only ... ")
print("#########################################################################")
print("#########################################################################")
print("#########################################################################")
print("#########################################################################")
...
png(filename=paste(results_dir,"/figureD6a.png",sep=""),width=5,height=4,units="in",res=600)
par(mar = c(2,5,2,2))
...
png(filename=paste(results_dir,"/figureD6b.png",sep=""),width=5,height=4,units="in",res=600)
par(mar = c(2,5,2,2))
...
png(filename=paste(results_dir,"/figureD6c.png",sep=""),width=5,height=4,units="in",res=600)
par(mar = c(2,5,2,2))
...
png(filename=paste(results_dir,"/figureD6d.png",sep=""),width=5,height=4,units="in",res=600)
par(mar = c(2,5,2,2))
...
png(filename=paste(results_dir,"/figureD6e.png",sep=""),width=5,height=4,units="in",res=600)
par(mar = c(2,5,2,2))
...
png(filename=paste(results_dir,"/figureD6f.png",sep=""),width=5,height=4,units="in",res=600)
par(mar = c(2,5,2,2))
...
print("#########################################################################")
print("#########################################################################")
print("###### END Calibration R script for GE_Calibration_HS_Markups_Sim_Only ...##")
print("#########################################################################")
print("#########################################################################")
print("#########################################################################")
print("#########################################################################")
