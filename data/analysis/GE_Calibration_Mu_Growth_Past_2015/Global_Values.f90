...
!	real*8 :: V_eqm(JJ,0:TT)
	...
	real*8 :: data_moments(Tobs,Nmoments), simulated_moments(Tobs,Nmoments)
	real*8 :: price_share_predictions(Tcutoff,5) ! in order ... sigma, norm_p, p, H, X
	real*8 :: loss_func(Nmoments,1) 	
	real*8 :: gy(1:Tcutoff)
	...
	real*8 :: mu_DATA(1:Tgrowth),pop0_DATA(0:13)!mu_DATA(1:13),pop0_DATA(0:13)
	real*8 :: A_h(0:TT)
	real*8 :: Z(0:TT) 
