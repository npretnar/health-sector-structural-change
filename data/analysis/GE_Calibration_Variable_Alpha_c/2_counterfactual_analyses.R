...
sink(paste0(results_dir,"/2_counterfactual_analyses_SCRIPT_GE_Calibration_Variable_Alpha_c.txt")) # prints in-line data into a txt file

print("#########################################################################")
print("#########################################################################")
print("#########################################################################")
print("Now running Calibration R script for GE_Calibration_Variable_Alpha_c ... ")
print("#########################################################################")
print("#########################################################################")
print("#########################################################################")
print("#########################################################################")
...
png(filename=paste(results_dir,"/figureD3a.png",sep=""),width=5,height=4,units="in",res=600)
par(mar = c(2,5,2,2))
...
png(filename=paste(results_dir,"/figureD9a.png",sep=""),width=5,height=4,units="in",res=600)
par(mar = c(2,5,2,2))
...
png(filename=paste(results_dir,"/figureD10a.png",sep=""),width=5,height=4,units="in",res=600)
par(mar = c(2,5,2,2))
...
png(filename=paste(results_dir,"/figureD3b.png",sep=""),width=5,height=4,units="in",res=600)
par(mar = c(2,5,2,2))
...
#le_counters_normalized$year = seq(1950,2050,5)
cols = c("blue","red","purple") #,"darkgreen","darkorange","gold2") #"goldenrod4","darkseagreen","cornflowerblue","darkcyan","darksalmon","gold2")
png(filename=paste(results_dir,"/figureD9b.png",sep=""),width=5,height=4,units="in",res=600)
par(mar = c(2,5,2,2))
...
#le_counters_normalized$year = seq(1950,2050,5)
cols = c("darkorange","darkcyan","goldenrod4") #"goldenrod4","darkseagreen","cornflowerblue","darkcyan","darksalmon","gold2")
png(filename=paste(results_dir,"/figureD10b.png",sep=""),width=5,height=4,units="in",res=600)
par(mar = c(2,5,2,2))
...
png(filename=paste(results_dir,"/figureD3c.png",sep=""),width=5,height=4,units="in",res=600)
par(mar = c(2,5,2,2))
...
#he_counters_normalized$year = seq(1950,2050,5)
cols = c("blue","red","purple") #,"darkgreen","darkorange","gold2") #"goldenrod4","darkseagreen","cornflowerblue","darkcyan","darksalmon","gold2")
png(filename=paste(results_dir,"/figureD9c.png",sep=""),width=5,height=4,units="in",res=600)
par(mar = c(2,5,2,2))
...
#he_counters_normalized$year = seq(1950,2050,5)
cols = c("darkorange","darkcyan","goldenrod4") #"goldenrod4","darkseagreen","cornflowerblue","darkcyan","darksalmon","gold2")
png(filename=paste(results_dir,"/figureD10c.png",sep=""),width=5,height=4,units="in",res=600)
par(mar = c(2,5,2,2))
...
png(filename=paste(results_dir,"/figureD3d.png",sep=""),width=5,height=4,units="in",res=600)
par(mar = c(2,5,2,2))
...
#k_share_normalized$year = seq(1950,2050,5)
cols = c("blue","red","purple") #,"darkgreen","darkorange","gold2") #"goldenrod4","darkseagreen","cornflowerblue","darkcyan","darksalmon","gold2")
png(filename=paste(results_dir,"/figureD9d.png",sep=""),width=5,height=4,units="in",res=600)
par(mar = c(2,5,2,2))
...
#k_share_normalized$year = seq(1950,2050,5)
cols = c("darkorange","darkcyan","goldenrod4") #"goldenrod4","darkseagreen","cornflowerblue","darkcyan","darksalmon","gold2")
png(filename=paste(results_dir,"/figureD10d.png",sep=""),width=5,height=4,units="in",res=600)
par(mar = c(2,5,2,2))
...
png(filename=paste(results_dir,"/figureD3e.png",sep=""),width=5,height=4,units="in",res=600)
par(mar = c(2,5,2,2))
...
#l_share_normalized$year = seq(1950,2050,5)
cols = c("blue","red","purple") #,"darkgreen","darkorange","gold2") #"goldenrod4","darkseagreen","cornflowerblue","darkcyan","darksalmon","gold2")
png(filename=paste(results_dir,"/figureD9e.png",sep=""),width=5,height=4,units="in",res=600)
par(mar = c(2,5,2,2))
...
#l_share_normalized$year = seq(1950,2050,5)
cols = c("darkorange","darkcyan","goldenrod4") #"goldenrod4","darkseagreen","cornflowerblue","darkcyan","darksalmon","gold2")
png(filename=paste(results_dir,"/figureD10e.png",sep=""),width=5,height=4,units="in",res=600)
par(mar = c(2,5,2,2))
...
png(filename=paste(results_dir,"/figureD3f.png",sep=""),width=5,height=4,units="in",res=600)
par(mar = c(2,5,2,2))
...
cols = c("blue","red","purple") #,"darkgreen","darkorange","gold2") #"goldenrod4","darkseagreen","cornflowerblue","darkcyan","darksalmon","gold2")
png(filename=paste(results_dir,"/figureD9f.png",sep=""),width=5,height=4,units="in",res=600)
par(mar = c(2,5,2,2))
...
#gy_counters_normalized$year = seq(1950,2050,5)
cols = c("darkorange","darkcyan","goldenrod4") #"goldenrod4","darkseagreen","cornflowerblue","darkcyan","darksalmon","gold2")
png(filename=paste(results_dir,"/figureD10f.png",sep=""),width=5,height=4,units="in",res=600)
par(mar = c(2,5,2,2))
...
print("#########################################################################")
print("#########################################################################")
print("###### END Calibration R script for GE_Calibration_Variable_Alpha_c ...##")
print("#########################################################################")
print("#########################################################################")
print("#########################################################################")
print("#########################################################################")
