...
sink(paste0(results_dir,"/2_counterfactual_analyses_SCRIPT_GE_Calibration_No_Mu_Growth.txt")) # prints in-line data into a txt file

print("#########################################################################")
print("#########################################################################")
print("#########################################################################")
print("Now running Calibration R script for GE_Calibration_No_Mu_Growth ... ")
print("#########################################################################")
print("#########################################################################")
print("#########################################################################")
print("#########################################################################")
...
png(filename=paste(results_dir,"/figureD5a.png",sep=""),width=5,height=4,units="in",res=600)
par(mar = c(2,5,2,2))
...
png(filename=paste(results_dir,"/figureD13a.png",sep=""),width=5,height=4,units="in",res=600)
par(mar = c(2,5,2,2))
...
png(filename=paste(results_dir,"/figureD14a.png",sep=""),width=5,height=4,units="in",res=600)
par(mar = c(2,5,2,2))
...
png(filename=paste(results_dir,"/figureD5b.png",sep=""),width=5,height=4,units="in",res=600)
par(mar = c(2,5,2,2))
...
#le_counters_normalized$year = seq(1950,2050,5)
cols = c("blue","red","purple") #,"darkgreen","darkorange","gold2") #"goldenrod4","darkseagreen","cornflowerblue","darkcyan","darksalmon","gold2")
png(filename=paste(results_dir,"/figureD13b.png",sep=""),width=5,height=4,units="in",res=600)
par(mar = c(2,5,2,2))
...
#le_counters_normalized$year = seq(1950,2050,5)
cols = c("darkorange","darkcyan","goldenrod4") #"goldenrod4","darkseagreen","cornflowerblue","darkcyan","darksalmon","gold2")
png(filename=paste(results_dir,"/figureD14b.png",sep=""),width=5,height=4,units="in",res=600)
par(mar = c(2,5,2,2))
...
png(filename=paste(results_dir,"/figureD5c.png",sep=""),width=5,height=4,units="in",res=600)
par(mar = c(2,5,2,2))
...
#he_counters_normalized$year = seq(1950,2050,5)
cols = c("blue","red","purple") #,"darkgreen","darkorange","gold2") #"goldenrod4","darkseagreen","cornflowerblue","darkcyan","darksalmon","gold2")
png(filename=paste(results_dir,"/figureD13c.png",sep=""),width=5,height=4,units="in",res=600)
par(mar = c(2,5,2,2))
...
#he_counters_normalized$year = seq(1950,2050,5)
cols = c("darkorange","darkcyan","goldenrod4") #"goldenrod4","darkseagreen","cornflowerblue","darkcyan","darksalmon","gold2")
png(filename=paste(results_dir,"/figureD14c.png",sep=""),width=5,height=4,units="in",res=600)
par(mar = c(2,5,2,2))
...
png(filename=paste(results_dir,"/figureD5d.png",sep=""),width=5,height=4,units="in",res=600)
par(mar = c(2,5,2,2))
...
#k_share_normalized$year = seq(1950,2050,5)
cols = c("blue","red","purple") #,"darkgreen","darkorange","gold2") #"goldenrod4","darkseagreen","cornflowerblue","darkcyan","darksalmon","gold2")
png(filename=paste(results_dir,"/figureD13d.png",sep=""),width=5,height=4,units="in",res=600)
par(mar = c(2,5,2,2))
...
#k_share_normalized$year = seq(1950,2050,5)
cols = c("darkorange","darkcyan","goldenrod4") #"goldenrod4","darkseagreen","cornflowerblue","darkcyan","darksalmon","gold2")
png(filename=paste(results_dir,"/figureD14d.png",sep=""),width=5,height=4,units="in",res=600)
par(mar = c(2,5,2,2))
...
png(filename=paste(results_dir,"/figureD5e.png",sep=""),width=5,height=4,units="in",res=600)
par(mar = c(2,5,2,2))
...
#l_share_normalized$year = seq(1950,2050,5)
cols = c("blue","red","purple") #,"darkgreen","darkorange","gold2") #"goldenrod4","darkseagreen","cornflowerblue","darkcyan","darksalmon","gold2")
png(filename=paste(results_dir,"/figureD13e.png",sep=""),width=5,height=4,units="in",res=600)
par(mar = c(2,5,2,2))
...
#l_share_normalized$year = seq(1950,2050,5)
cols = c("darkorange","darkcyan","goldenrod4") #"goldenrod4","darkseagreen","cornflowerblue","darkcyan","darksalmon","gold2")
png(filename=paste(results_dir,"/figureD14e.png",sep=""),width=5,height=4,units="in",res=600)
par(mar = c(2,5,2,2))
...
png(filename=paste(results_dir,"/figureD5f.png",sep=""),width=5,height=4,units="in",res=600)
par(mar = c(2,5,2,2))
...
cols = c("blue","red","purple") #,"darkgreen","darkorange","gold2") #"goldenrod4","darkseagreen","cornflowerblue","darkcyan","darksalmon","gold2")
png(filename=paste(results_dir,"/figureD13f.png",sep=""),width=5,height=4,units="in",res=600)
par(mar = c(2,5,2,2))
...
#gy_counters_normalized$year = seq(1950,2050,5)
cols = c("darkorange","darkcyan","goldenrod4") #"goldenrod4","darkseagreen","cornflowerblue","darkcyan","darksalmon","gold2")
png(filename=paste(results_dir,"/figureD14f.png",sep=""),width=5,height=4,units="in",res=600)
par(mar = c(2,5,2,2))
...
print("#########################################################################")
print("#########################################################################")
print("###### END Calibration R script for GE_Calibration_No_Mu_Growth ...##")
print("#########################################################################")
print("#########################################################################")
print("#########################################################################")
print("#########################################################################")
